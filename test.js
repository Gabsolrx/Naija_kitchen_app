...
code = code.replace(/<Link to=\{`\/recipe\/\$\{recipe\.id\}`\} className=/g, "<div onClick={async () => { await AdMobService.showInterstitialWithCap(); navigate(`/recipe/${recipe.id}`); }} className=");
